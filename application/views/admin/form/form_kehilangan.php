<body>
	  <div class="container">
  <br>
  <h4><div class="center title-form">Form Kehilangan Barang</div></h4>
  <br>
    <form action="<?php echo base_url('admin/buat_form_kehilangan');?>" method="post">
      <div class="row">
        ...
        <div class="input-field col s12 m6">
          <input name="nama_pemilik" type="text" class="validate"  value="<?php echo $this->session->userdata('nama');?>" disabled>
    ...
    <label>Kategori barang</label>
      ...
      <div class="row">
        ...
        <div class="input-field col s12 m6" required>
          <textarea name="tempat_kehilangan" class="materialize-textarea" data-length="25"></textarea>
