  ...
  <div class="container">
    <div class="row">
      ...
      <!-- <div class="col s12 m4">
        ...
        <div class="card medium">
          <div class="card-image waves-effect waves-block waves-light">
            <img class="activator" src="<?php echo base_url('assets/img/tas.png');?>">
          </div>
          <div class="card-content">
            <span class="card-title activator grey-text text-darken-4">Judul Barang<i class="material-icons right">more_vert</i></span>
            <p class="info">Dipost oleh: asd</p>
          </div>
          <div class="card-reveal">
            <span class="card-title grey-text text-darken-4">Judul Barang<i class="material-icons right">close</i></span>
            <p>Detail barang: <br>
              <br>
              Warna: merah<br>
              Ciri khusus: ada stiker filkom<br>
              Waktu & tempat kehilangan: 9 pagi di Gazebo FILKOM<br>
              Info tambahan: Bagi yang menemukan harap menghubungi CP di bawah ini<br>
            CP: 08123456789<br></p>
          </div>
          <div class="card-action">
            <p class="info">CP:</p>
