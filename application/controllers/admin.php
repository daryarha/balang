...
{   
    ...
    function post(){
        ...
        $this->load->view('admin/index',$core);
    ...
    function list_menemukan(){
        $data = $this->fungsi->Menemukan();
        $data = array('data' => $data);
        $this->load->view('header');
        $this->load->view('admin/nav');
        $this->load->view('admin/list_menemukan',$data);
        $this->load->view('footer');
    }
	...
	function form_menemukan(){
        ...
        $this->load->view('header');
        $this->load->view('admin/nav');
		$this->load->view('admin/form/form_menemukan',$data);
        $this->load->view('footer');
	}
    ...
    function update_menemukan(){
        ...
        if ($res>0) {
            redirect('/admin/list_menemukan','refresh');
        }
    }
    ...
    function form_kehilangan(){
        ...
        $this->load->view('header');
        $this->load->view('admin/nav');
        $this->load->view('admin/form/form_kehilangan',$data);
        $this->load->view('footer');
    }

    function list_kehilangan(){
        $data = $this->fungsi->Kehilangan();
        $data = array('data' => $data);
        $this->load->view('header');
        $this->load->view('admin/nav');
        $this->load->view('admin/list_kehilangan',$data);
        $this->load->view('footer');
    }
    ...
    $res = $this->fungsi->Update('apps_balang_kehilangan', $data, $where);
        if ($res>0) {
            redirect('/admin/list_kehilangan','refresh');
        }
    }
